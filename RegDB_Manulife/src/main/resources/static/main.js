...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.SaveUserDetails = function (user) {
        return this._http.post("https://regdb-businesslogic-service-dev.apps.eas.pcf.manulife.com", JSON.stringify(user), this.options);
    };
    UserService.prototype.updateUserDetails = function (user) {
        return this._http.put("https://regdb-businesslogic-service-dev.apps.eas.pcf.manulife.com", JSON.stringify(user), this.options);
    };
